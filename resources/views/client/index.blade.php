...
<div class="page-content">
                    ...
                    @if($status === '1')
                    <h4>Your Restaurant Account is <span class="text-success">Active</span></h4>
                    ...
                    @else
                    <h4>Your Restaurant Account is <span class="text-danger">InActive</span></h4>
                    <p>Please Wait For Admin Aprrove</p>
                    @endif
