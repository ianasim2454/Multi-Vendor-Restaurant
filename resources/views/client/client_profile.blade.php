            ...
            <div class="col-lg-6">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="cover_photo" type="file" value="" id="cover_image">
                    </div> 
                    <div class="mb-3">
                    <img src="{{ (!empty($profileData->cover_photo)) ? url('upload/cover/'.$profileData->cover_photo) : url('upload/no_image.jpg') }}" alt="" id="showCoverImage" class="p-1 bg-primary" width="210" height="100">
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                        ...
                        <select name="city_id" class="form-select">
                            ...
                            <option value="{{$cities->id}}" {{ $cities->id == $profileData->city_id ? 'selected' : ''}}>{{$cities->city_name}}</option>
                            @endforeach
                        </select>
                    </div> 
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                    <img src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" id="showImage" class="rounded-circle p-1 bg-primary" width="110">
                    </div>
