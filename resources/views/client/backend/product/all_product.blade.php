                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @endif    
                                                ...
                                                <td>
                                                <a class="btn btn-info waves-effect waves-light" href="{{route('edit.product',$item->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger waves-effect waves-light"  href="{{route('delete.product',$item->id)}}" id="delete"><i class="fa fa-trash"></i></a>
