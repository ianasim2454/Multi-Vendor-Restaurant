...
<div class="card">
    ...
    <form id="myForm" action="{{ route('update.coupon',$coupon->id) }}" method="post" enctype="multipart/form-data"> 
        @csrf  
        <div class="row">
            <div class="col-xl-4 col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="coupon_description" id="basicpill-address-input" class="form-control" rows="2" placeholder="Enter Coupon Description">{{$coupon->coupon_description}}</textarea>
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="validity" type="date" value="{{$coupon->validity}}" id="example-text-input" min="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                    </div> 
