...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
            ...
            @php 
               $products = App\Models\Product::latest()->where('client_id',$client->id)->limit(3)->get();
               ...
               $menuNamesString1 = implode(' , ',$menuNames);
               $coupons = App\Models\Coupon::latest()->where('client_id',$client->id)->where('status','1')->first();
            @endphp
...
<section class="restaurant-detailed-banner">
         <div class="text-center">
            <img class="img-fluid cover" src="{{asset('upload/cover/'.$client->cover_photo)}}">
         </div>
               ...
               <div class="row d-flex align-items-end">
                  <div class="col-md-8">
                     <div class="restaurant-detailed-header-left">
                        ...
                        @else
                        <h5 class="badge badge-danger">Have No Menu</h5>
                        @endif
                        </p>
                     </div>
                  </div>
                     ...
                     <div class="tab-content" id="pills-tabContent">
                                 ...
                                 <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                    ...
                                    <div class="p-3 position-relative">
                                       <div class="list-card-body">
                                          ...
                                          <p class="text-gray mb-2">{{$menuNamesString}}</p>
                                          <p class="text-gray time mb-0"><a class="btn btn-link btn-sm text-black" href="#">     
                                             @if($bestseller->discount_price == NULL)
                                              ${{$bestseller->price}}
                                            @else
                                                $<del>{{$bestseller->price}}</del> ${{$bestseller->discount_price}}  
                                          @endif
                        ...
                        <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel" aria-labelledby="pills-restaurant-info-tab">
                           <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                              ...
                              <p class="mb-2 text-black"><i class="icofont-email text-primary mr-2"></i> {{$client->shop_info}}</p>
                              <hr class="clearfix">
                              ...
                              <p class="mb-3">{{$menuNamesString1}}</p>
   ...
   @endphp
               ...
               @if ($coupon == NULL)
                ...
                @else
                <p class="mb-0">{{ $coupon->discount }}% off on orders | Use coupon <span class="text-danger font-weight-bold">{{ $coupon->coupon_name }}</span></p>
                @endif
