...
<div class="col-md-3">
                  <div class="osahan-account-page-left shadow-sm rounded bg-white h-100">
                     ...
                     <li class="nav-item">
                        ...
                        <li class="nav-item">
                           <a class="nav-link {{Route::CurrentRouteName() === 'user.change.password' ? 'active' : ''}}" href="{{route('user.change.password')}}" role="tab" aria-controls="orders" aria-selected="true"><i class="icofont-food-cart"></i> Change Password</a>
                        </li>
