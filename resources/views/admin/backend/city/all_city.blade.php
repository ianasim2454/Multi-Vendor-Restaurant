                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myEdit" id="{{ $item->id }}" onclick="cityEdit(this.id)">Edit City</button>
            ...
            <div class="col-lg-12">
                <div>
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="city_name" type="text" value="" id="example-text-input">
                    </div> 
        ...
        <div class="row">
            <div class="col-lg-12">
                <div>
                    <div class="form-group mb-3">
                        <label for="example-text-input" class="form-label">City Name</label>
                        <input class="form-control" name="city_name" type="text" value="" id="cat">
                    </div>
