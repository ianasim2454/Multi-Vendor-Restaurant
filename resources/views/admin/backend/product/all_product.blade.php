                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td><img src="{{asset($item->image)}}" alt="" style="width: 70px; height: 80px"></td>
                                                <td>{{$item->name}}</td>
                                                <td>{{$item ['menu']['menu_name']}}</td>
                                                <td><span class="bg-danger">{{$item ['client']['name']}}</span></td>
                                                <td>{{$item->price}}</td>
                                ...
                                @endif    
                                                ...
                                                <td>
                                                <a class="btn btn-info waves-effect waves-light" href="{{route('admin.edit.product',$item->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger waves-effect waves-light"  href="{{route('admin.delete.product',$item->id)}}" id="delete"><i class="fa fa-trash"></i></a>
